...
* [X] 1. "Rails Week" Conversation
* [X] 2. MVC Review
* [X] 3. Quickly build simple Rails app
* [X] 4. Nested Resources
...
- [Secure random](https://github.com/ruby/securerandom)
- [Action controller](https://api.rubyonrails.org/v7.1.2/classes/ActionController/Redirecting.html)
- [Active record queries](https://guides.rubyonrails.org/active_record_querying.html)
